...
playerImage = pygame.image.load('C:\\Users\\hp\\Desktop\\game png\\ship.png')
...
for num in range(no_of_invaders):
    invaderImage.append(pygame.transform.scale(pygame.image.load('C:\\Users\\hp\\Desktop\\game png\\ghost.png'),(100,100)))
    invader_X.append(random.randint(64, 737))
    invader_Y.append(random.randint(30, 180))
    invader_Xchange.append(1.2)
    invader_Ychange.append(50)

bulletImage = pygame.image.load('C:\\Users\\hp\\Desktop\\game png\\as.jpg')
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                ...
                if bullet_state == "rest":
                    ...
                    bullet_sound = mixer.Sound('C:\\Users\\hp\\Desktop\\game sound\\sound1.wav')
                    bullet_sound.play()
        ...
        if invader_Y[i] >= 450:
            if abs(player_X - invader_X[i]) < 80:
                for j in range(no_of_invaders):
                    invader_Y[j] = 2000
                    explosion_sound = mixer.Sound('C:\\Users\\hp\\Desktop\\game sound\\sound.wav')
                    bullet_sound.stop()
